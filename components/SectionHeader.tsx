    ...
    return (
        <div className={`min-h-[60vh] md:min-h-[50vh] relative flex items-center`}>
            <div className="absolute inset-0 w-full h-full">
                ...
                <div className={`absolute ${title.toLowerCase().startsWith("swiftrun") ? "bg-black/80" : "bg-black/60 "} inset-0 w-full h-full flex items-center justify-center flex-col text-white gap-10 px-5 md:px-10`}>
