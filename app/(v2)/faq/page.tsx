      ...
      <SectionHeader title='Common Questions' description='' children={
        <div className='flex items-center justify-center'>
          <div className='flex gap-10 mt-4 text-sm w-full flex-col md:flex-row'>
            ...
            <Link href={"#customer"} className='bg-[#FFB5CB] group  py-2 flex items-center justify-center w-full md:w-[40%] rounded-full text-black'>
                <LearnMore text="Customers" />
            </Link>
            <Link href={"#riders"} className='bg-[#FFB5CB] group  py-2 flex items-center justify-center w-full md:w-[40%] rounded-full text-black'>
                <LearnMore text="Riders" />
            </Link>
            <Link href={"#business"} className='bg-[#FFB5CB] group  py-2 flex items-center justify-center w-full md:w-[40%] rounded-full text-black'>
