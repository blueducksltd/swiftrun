        ...
        <div>
            <header className='h-[70vh] flex items-center justify-center relative'>
                <div className='relative z-20 flex items-center justify-center flex-col'>
                    <h1 className='text-[60px] text-white font-bold'>SwiftRun Business</h1>
                    <p className='text-[#FFDEBC]'>Everything Delivered</p>

                    <div className='my-10 flex items-center  gap-4'>
                        <Link href="/stores" className="bg-[#FFDEBC] flex items-center justify-center w-full  md:w-fit py-2 px-14 text-sm rounded-full transition duration-300 font-primary">
                            Login
                        </Link>

                        <Link href="/stores" className="bg-[#FFB5CB] flex items-center justify-center w-full  md:w-fit py-2 px-14  rounded-full transition duration-300 font-primary">
                            Register
                        </Link>
                    </div>
                </div>
            ...
            <div className='bg-[#DDEEFF] py-10 px-10 md:px-30'>
                <p className="text-center text-xl"><b className="font-heading">Features</b> How it works</p>

                <div className='my-20 grid gap-10'>
                    <div className=' bg-linear-to-r text-white from-[#56B1FF] to-[#46A0FF] p-10 rounded-[60px] flex  justify-center flex-col shadow-[0px_0px_30px_#5EAEFE80]'>
                        <h1 className='text-[100px] font-bold'>00%</h1>
                        <h1 className='text-2xl'>Commission Charge</h1>
                    </div>

                    <div className=' bg-linear-to-r text-black bg-white  p-10 rounded-[60px] flex  justify-center flex-col shadow-[0px_13px_70px_rgba(0,0,0,.05)] gap-4'>
            ...
            <div className='py-10 px-10 md:px-30'>
                <SectionHeaderTexts paragraph=' Get Started
' heading='How SwiftRun works' reverse />


                <div className='grid grid-cols-1 md:grid-cols-2 gap-7 px-5 md:px-10 py-10'>
                    {
                        features.map((feature, index) => <AnimationSection key={index} animation={index % 2 ? "slideLeft" : "slideRight"} amount={0.3}>
                            <div key={index} className={`h-100  pb-3  flex flex-col justify-between bg-linear-to-br ${feature.background} rounded-[40px] overflow-hidden`}>
                                <div className='h-[60%] bg-[#D9D9D9] relative'>
                                    <Image alt='' src={feature.image} fill />
                                ...
                                <div className='p-7  text-left text-white grid gap-3'>
                                    <h1 className={`text-2xl font-bold ${feature.color}`}>{feature.title}</h1>
